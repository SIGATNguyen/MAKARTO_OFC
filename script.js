...
function handleStepEnter(response) {
  ...
  try {
    switch(id) {
      ...
      case "hiroshima":
        map.flyTo({ center: [132.49214, 34.39090], zoom: 11.4, bearing: -8, pitch: 18, duration: 8000 });
      ...
      case "nagasaki":
        map.flyTo({ center: [129.87881, 32.75857], zoom: 12.1, bearing: -49.60, pitch: 34.50, duration: 8000 });
      ...
      case "rennes-impact":
        map.flyTo({ center: [-1.64124, 48.11316], zoom: 11.4, bearing: 0, pitch: 0, duration: 8000});
